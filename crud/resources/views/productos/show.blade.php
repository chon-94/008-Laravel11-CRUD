            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400">${{ number_format($producto->compra, 2) }}</p>
                    </div>

                    <!-- Campo: Precio Venta -->
                    <div>
                        <strong class="text-gray-700 dark:text-gray-300">Precio Venta:</strong>
                        <p class="text-gray-600 dark:text-gray-400">${{ number_format($producto->venta, 2) }}</p>
                    </div>
                    ...
                    <!-- Campo: Fecha de Caducidad (solo si es perecedero) -->
