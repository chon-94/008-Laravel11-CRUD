        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('productos.store') }}" method="POST">
                    @csrf
                    <!-- Laravel no necesita @method('POST') en formularios POST, pero puedes dejarlo si lo prefieres -->
                    @method('POST')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Campo Fecha Caducidad (solo visible si es perecedero) -->
                        ...
                        <!-- Campo Descripción (ocupa las dos columnas en pantallas grandes) -->
...
<!-- Script para mostrar u ocultar campo de fecha de caducidad -->
<script>
