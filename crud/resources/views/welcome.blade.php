...
<main class="mt-20 mb-1">
    <!-- Sección principal: Grid de cards -->
    <div class="grid gap-4 lg:grid-cols-2 lg:gap-x-6 lg:gap-y-8">

        <!-- Card destacada (puede ser documentación u otra info relevante) -->
        <a href="#" id="docs-card"
        ...
        <a href="{{ route('productos.index') }}"
           class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            ...
            <div class="pt-3 sm:pt-5">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Gestiona tus productos fácilmente</p>
            </div>
        ...
        <a href="#"
           class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            ...
            <div class="pt-3 sm:pt-5">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Ver historial de movimientos</p>
            </div>
